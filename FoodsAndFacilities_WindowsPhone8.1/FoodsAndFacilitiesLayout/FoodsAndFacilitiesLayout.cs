...
namespace FoodsAndFacilitiesLayout
{
    public class FoodsAndFacilitiesLayout : Grid
    {
        ...
        public static readonly DependencyProperty IsDrawerOpenProperty = DependencyProperty.Register("IsDrawerOpen", typeof(bool), typeof(FoodsAndFacilitiesLayout), new PropertyMetadata(false));
        ...
        public FoodsAndFacilitiesLayout()
        {
            IsDrawerOpen = false;
        }
