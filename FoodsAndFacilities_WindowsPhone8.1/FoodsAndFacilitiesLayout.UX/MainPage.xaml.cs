...
namespace FoodsAndFacilities.UX
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            FoodsAndFacilitiesLayout.InitializeFoodsAndFacilitiesLayout();
        ...
        {
            if (FoodsAndFacilitiesLayout.IsDrawerOpen)
            {
                FoodsAndFacilitiesLayout.CloseDrawer();
                e.Handled = true;
            }
            else
            {
        ...
        private void DrawerIcon_Tapped(object sender, TappedRoutedEventArgs e)
        {
            if (FoodsAndFacilitiesLayout.IsDrawerOpen)
                ...
                FoodsAndFacilitiesLayout.OpenDrawer();
        }
